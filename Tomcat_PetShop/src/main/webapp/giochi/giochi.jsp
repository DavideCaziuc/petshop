...
<body>
	<div class="navbar">
		...
		<div class="navbar-links">
			<a href="../utente/utente.jsp">Utente</a> <a href="../animale/animale.jsp">Animale</a> <a
				href="../cliente/cliente.jsp">Cliente</a> <a href="giochi.jsp">Giochi</a>
			<a href="../cibo/cibo.jsp">Cibo</a> <a
				href="../supporto/supporto.jsp">Supporto</a>
		</div>
	...
	<div class="container">
		<h1>La pagina "Giochi" è ancora in via di sviluppo</h1>
