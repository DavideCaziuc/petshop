...
<%
    ...
    List<Animale> sublist = lista.subList(start, end);
...
<div class="navbar">
		...
		<div class="navbar-links">
			<a href="../utente/utente.jsp">Utente</a> <a
				href="animale.jsp">Animale</a> <a href="../cliente/cliente.jsp">Cliente</a>
    ...
    <c:choose>
        <c:when test="${username != null && statoUtente == 'A'}">
            ...
            <table border="1" width="90%">
                ...
                <c:forEach items="${sublist}" var="a">
                    <tr>
                        <td>${a.getId()}</td>
                        <td>${a.getMatricola()}</td>
                        <td>${a.getNome_animale()}</td>
                        <td>${a.getData_acquisto()}</td>
                        <td>${a.getPrezzo()}</td>
                        <td>${a.getTipo_animale()}</td>
